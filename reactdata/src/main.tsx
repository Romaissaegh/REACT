...
ReactDOM.createRoot(document.getElementById('root')!).render(
  <React.StrictMode>
    ...
    <Descr content={["I am a competitive programmer & a computer engineering student. I started my programming journey through MOI when I was in middle school, where I improved my problem solving skills during the last 6 years."]}></Descr>
    <Section_Title title='Education'></Section_Title>
    <section>
        <section className='Education'><label className='BigName'> CPGE Moulay Driss:</label><label className='SMName'>Fes, Morocco</label><br/><label className='midText'> Maths and physics</label><label className='SMName'>2021-2023</label></section>
        <section><label className='BigName'> Ecole Mohamadia d'Ingenieurs:</label><label className='SMName'>Rabat, Morocoo</label><br/><label className='midText'> Computer science engineering</label><label className='SMName'>2023-expected graduation in 2026</label></section> 
    </section>
    ...
    <br/>
    <Organisation date={'2021-2023'} role={'Co-Director'} name={'CP square'} location={'Morocco'}/>
    </section>
    </div>
  </React.StrictMode>,
)
